    ...
    <body>
        ...
        <section id="box-profile">
            <div class="img-profile">
                <div class="photo" style="background-image:url(asset/img/profil.jpg);"></div>
            </div>
            ...
            <div class="information">
                ...
                <div class="data">
                    ...
                    <p id="pYears" class="text-gray"><?php echo $years_experience; ?></p>
                </div>
                <div class="data">
        ...
        <script>
            ...
            function editForm(){
                ...
                var Experience = document.getElementById("pYears").innerHTML;
